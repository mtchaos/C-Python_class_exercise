...
int main(){
    ...
    double dt[2] = {2*pi/160000,2*pi/250000};
    ...
    fprintf(gp, "plot '-' with points pointtype 1 title \"Euler Method dt = %lf\"\n",DT);
    
    while(t < 45){
        t += DT;
        old_y1 = y1;
        old_y2 = y2;
        y1 = old_y1 + DT*f1(old_y1,old_y2);
        y2 = old_y2 + DT*f2(old_y1,old_y2);
        
        if(40 < t){
            fprintf(gp,"%f\t%f\n", t, y1);
        }
        /*
        if( 41.9999 < t && t < 42.00005){
