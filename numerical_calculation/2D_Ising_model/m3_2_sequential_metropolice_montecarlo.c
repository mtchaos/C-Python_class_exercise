...
//トーラス状の二次元強磁性イジングモデルをメトロポリス法でシュミレーションして、磁化を計算する。
...
int main(int argc,char const * argv[]){
    ...
    fprintf(gp, "plot '-' with points pointtype 1 title \"Metropolice Method Ising Model L = %d\"\n",L);
    ...
    seed[3] = (unsigned int)(time(NULL)+3);
